...
class Actor(nn.Module):
    ...
    #def __init__(self, state_size, action_size, seed, fc1_units=400, fc2_units=300): - Ok
    #def __init__(self, state_size, action_size, seed, fc1_units=256, fc2_units=128): - Lento
    #def __init__(self, state_size, action_size, seed, fc1_units=512, fc2_units=256): - Oscila
